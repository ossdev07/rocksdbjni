        ...
        extends Iterable<Map.Entry<byte[], byte[]>>, Closeable
{
    ...
    void destroydb(File path, Options options);
    
    void destroyColumnFamily(ColumnFamilyHandle columnHandle);
    ...
    void DefaultColumnFamily() throws IOException, DBException; 
     ...
     */
    void compactRange(CompactRangeOptions compactOptions, byte[] begin, byte[] end)
            throws DBException;

	void deleteRange(ColumnFamilyHandle handle, byte[] begin, byte[] end)throws DBException;
	
	int numberLevels()
            throws DBException;

	void singleDelete(byte[] key)throws DBException;

	boolean getIntProperty(String string)throws DBException;
	
	boolean keyMayExist(byte[] key, ReadOptions options)
            throws DBException;
}
